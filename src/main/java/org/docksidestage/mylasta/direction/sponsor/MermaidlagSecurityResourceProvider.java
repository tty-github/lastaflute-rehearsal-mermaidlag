 ...
 * @author jflute
 */
public class MermaidlagSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public MermaidlagSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
