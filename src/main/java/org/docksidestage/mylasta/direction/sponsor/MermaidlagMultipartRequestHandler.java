 ...
 */
public class MermaidlagMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(MermaidlagMultipartRequestHandler.class);
    ...
    protected void throwTooLongBoundarySizeException(String contentType, int boundarySize, int limitSize) {
        ...
        br.addElement(" in " + MermaidlagMultipartRequestHandler.class.getSimpleName() + ".");
