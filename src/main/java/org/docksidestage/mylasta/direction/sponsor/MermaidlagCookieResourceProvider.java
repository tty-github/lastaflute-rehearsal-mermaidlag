 ...
 * @author jflute
 */
public class MermaidlagCookieResourceProvider implements CookieResourceProvider {

    protected final MermaidlagConfig mermaidlagConfig;
    protected final InvertibleCryptographer cookieCipher;

    public MermaidlagCookieResourceProvider(MermaidlagConfig mermaidlagConfig, InvertibleCryptographer cookieCipher) {
        this.mermaidlagConfig = mermaidlagConfig;
        this.cookieCipher = cookieCipher;
    }

    public String provideDefaultPath() {
        return mermaidlagConfig.getCookieDefaultPath();
    }

    public Integer provideDefaultExpire() {
        return mermaidlagConfig.getCookieDefaultExpireAsInteger();
    }
