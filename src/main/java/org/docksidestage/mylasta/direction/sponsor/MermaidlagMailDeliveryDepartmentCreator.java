 ...
 * @author jflute
 */
public class MermaidlagMailDeliveryDepartmentCreator {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MermaidlagMailDeliveryDepartmentCreator(MermaidlagConfig mermaidlagConfig) {
    ...
    protected SMailPostalParkingLot createPostalParkingLot() {
        ...
        final String hostAndPort = mermaidlagConfig.getMailSmtpServerMainHostAndPort();
        ...
        motorbike.registerReturnPath(mermaidlagConfig.getMailReturnPath());
    ...
    protected SMailPostalPersonnel createPostalPersonnel() {
        ...
        return mermaidlagConfig.isMailSendMock() ? personnel.asTraining() : personnel;
    }

    protected SMailDogmaticPostalPersonnel createDogmaticPostalPersonnel() { // #ext_point e.g. locale, database
        final String testPrefix = mermaidlagConfig.getMailSubjectTestPrefix();
