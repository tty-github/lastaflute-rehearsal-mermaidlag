 ...
 * @author jflute
 */
public class MermaidlagLoginAssist extends TypicalLoginAssist<Integer, MermaidlagUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected MermaidlagUserBean createUserBean(Member userEntity) {
        return new MermaidlagUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(mermaidlagConfig.getCookieRememberMeMermaidlagKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, MermaidlagUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<MermaidlagUserBean> getUserBeanType() {
        return MermaidlagUserBean.class;
    }
